...
typedef ::rf24_pa_dbm_e rf24_pa_dbm_e;
typedef ::rf24_datarate_e rf24_datarate_e;
typedef ::rf24_crclength_e rf24_crclength_e;
typedef ::rf24_fifo_state_e rf24_fifo_state_e;
typedef ::rf24_irq_flags_e rf24_irq_flags_e;

/** Main nRF24L01+ component with full original RF24 API compatibility */
class NRF24Component : public Component, public spi::SPIDevice<spi::BIT_ORDER_MSB_FIRST,
 ...
 public:
  ...
  // FIFO status
  rf24_fifo_state_e isFifo(bool tx);
  bool txStandBy();
